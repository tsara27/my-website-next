---
slug: defx-file-explorer-for-neovim
title: Defx, File Explorer for Neovim
...
I recently tried to check neovim startup time. The result was showing that
NERDTree is quite slow in the startup time. So, I tried to search for other file
explorer plugin. I found defx, the one that is lighter than NERDTree, that also
has similar functionality with NERDTree. You can find the plugin
[here](https://github.com/Shougo/defx.nvim).
